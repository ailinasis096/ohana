...
const filters = [
  ...
  { id: 2, name: 'ONGs', icon: <PeopleIcon /> },
  {
    id: 3,
    name: 'Medio Ambiente',
    icon: <SpaIcon />
  },
  { id: 4, name: 'Salud', icon: <AccessibilityNewIcon /> },
  { id: 5, name: 'Otros', icon: <FavoriteIcon /> }
]
    ...
    <div className="EventsContainer">
      <div className={classes.divHeader}>
        <Typography variant="h5" color="secondary">
          <Box fontWeight="fontWeightBold">Explora campañas</Box>
        </Typography>
      </div>
                  ...
                  title={
                    <Tooltip title={event.name}>
                      <Typography className={classes.cardTitle} variant="h6">
                        <Box fontWeight="fontWeightBold">{event.name}</Box>
                      </Typography>
                    </Tooltip>
                  }
                  action={
